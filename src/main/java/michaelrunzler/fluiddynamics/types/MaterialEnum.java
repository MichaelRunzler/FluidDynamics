...
public enum MaterialEnum
{
    ...
    COPPER(     1.5f, 12, 0.7f, 0.7f, 0.7f, 20, 0.7f, 1357.8f, 401.0f, "Copper"), // Soft, not bad for armor or tools, common and easy to work with
    TIN(        0.8f, 8,  0.4f, 0.4f, 0.4f, 13, 0.4f, 505.1f,  66.8f, "Tin"),  // Very bad for tools, only useful for alloys
    BERYLLIUM(  3.5f, 17, 0.8f, 1.2f, 0.7f, 25, 1.1f, 1560.0f, 200.0f, "Beryllium"), // Hard, but brittle
    SILICON(    2.7f, 10, 0.2f, 0.8f, 0.2f, 15, 0.2f, 1687.0f, 149.0f, "Crystalline Silicon"), // Terrible. What do you expect from crystalline silicon?
    COBALT(     4.5f, 16, 1.5f, 1.3f, 1.5f, 10, 1.3f, 1768.0f, 100.0f, "Cobalt"), // A good improvement over iron, hard and durable but not that much better
    OSMIUM(     7.5f, 20, 2.0f, 2.2f, 2.0f, 5,  5.0f, 3306.0f, 87.6f, "Sintered Osmium"),  // Very good; as or more effective as diamond but not as enchantable and harder to get
    ALUMINIUM(  1.3f, 10, 0.7f, 1.0f, 0.7f, 20, 0.6f, 933.5f,  237.0f, "Aluminium"), // Not great due to its softness, but enchantable, like gold
    NICKEL(     3.0f, 16, 0.9f, 1.1f, 0.9f, 8,  1.0f, 1728.0f, 90.9f, "Nickel"),  // Almost identical to iron but a bit more hard and brittle
    TITANIUM(   7.0f, 20, 4.0f, 2.5f, 3.0f, 15, 4.0f, 1941.0f, 21.9f, "Titanium"),  // Super hard and durable, but rare and a pain to work with
    TUNGSTEN(   6.0f, 18, 0.8f, 1.5f, 0.8f, 12, 2.0f, 3695.0f, 173.0f, "Sintered Tungsten"), // Hard but not that durable; also a pain because of its high melt point
 ...
 SUPERCONDUCTOR(7.5f, 18, 1.6f, 1.5f, 1.6f, 50, 1.9f, 4125.0f, 1345.0f, "Superconducting Alloy"),// A bit worse than osmium or iridium, but insanely enchantable
    SHARICITE(  30.0f,24, 5.0f, 4.0f, 4.0f, 0,  100f, 8600.0f, 11.0f, "Energized Sharicite"),  // Incredibly effective and better than Osmiridium for tools, but hard to obtain and completely unenchantable
    OSMIRIDIUM( 30.0f,26, 10.0f,1.5f, 10.0f,10, 1000f,4352.0f, 123.2f, "Osmiridium Superalloy"); // Even more durable than Sharicite, and makes excellent armor, but not very good as tool material
