...
public enum OreEnum
{
    ...
    BERTRANDITE(    3.5f, 2, 1, 6, 1.0f, 0,  48, OreEnumConsts.OVERWORLD, OreEnumConsts.STANDARD, "Bertrandite"),
    SPHEROCOBALTITE(5.0f, 3, 1, 8, 0.5f, 0,  32, OreEnumConsts.OVERWORLD, OreEnumConsts.STANDARD, "Spherocobaltite"),
    TETRATAENITE(   50.0f,4, 1, 2, 0.2f, 56, 192,OreEnumConsts.OVERWORLD, BlockTags.DIRT, "Tetrataenite"),
    ...
    PENTLANDITE(    4.5f, 2, 3, 10,0.8f, 10, 48, OreEnumConsts.OVERWORLD, OreEnumConsts.STANDARD, "Pentlandite");
    ...
    OreEnum(float hardness, int miningLevel, int minSize, int maxSize, float rarity, int minY, int maxY,
            int[] genDimIDs, TagKey<Block> canReplace, String englishName)
    {
...
class OreEnumConsts{
    ...
    static final TagKey<Block> STANDARD = BlockTags.STONE_ORE_REPLACEABLES;
}
